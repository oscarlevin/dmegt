...
<xsl:import href="dmegt-common.xsl" />
...
<xsl:param name="exercise.worksheet.hint" select="'yes'" />
<xsl:param name="exercise.worksheet.answer" select="'no'" />
<xsl:param name="exercise.worksheet.solution" select="'yes'" />
...
<xsl:param name="webwork.inline.static" select="'yes'" />
